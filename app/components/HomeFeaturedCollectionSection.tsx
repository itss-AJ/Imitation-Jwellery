...
const PRODUCTS = [
  {
    id: "69562cc62c9e2fba8807ad20", // Updated mock IDs to real MongoDB ObjectIDs
    title: "Glossy Heart Stud",
    price: "Rs. 799.00",
    image: "/img/earring.webp",
  },
  {
    id: "69562cc62c9e2fba8807ad25", // Updated mock IDs to real MongoDB ObjectIDs
...
const PRODUCTS2 = [
  {
    id: "69562cc62c9e2fba8807ad1c", // Updated mock IDs to real MongoDB ObjectIDs
    title: "Glossy Heart Stud",
    price: "Rs. 799.00",
    image: "/img/bracelet-img.webp",
  },
  {
    id: "69562cc62c9e2fba8807ad1d", // Updated mock IDs to real MongoDB ObjectIDs
    title: "Interlocking Hoop Earring",
    price: "Rs. 1,299.00",
      ...
      <div className="flex flex-col gap-10 max-w-[1560px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-10 items-start">
          <div className="lg:col-span-1">
            <div className="relative h-[280px] md:h-[480px] rounded-2xl overflow-hidden">
              <video
                src="/images/files-blob-privora-main-public-video-jewelrywoman.mp4"
                autoPlay
                playsInline
                loop
                muted
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-10 items-start">
          ...
          <div className="lg:col-span-1 featuredCollectionBestSellerVdo">
            <div className="relative h-[280px] md:h-[480px] rounded-2xl overflow-hidden">
              <video
                src="/images/files-blob-privora-main-public-video-jewelrywoman2.mp4"
                autoPlay
                playsInline
                loop
                muted
